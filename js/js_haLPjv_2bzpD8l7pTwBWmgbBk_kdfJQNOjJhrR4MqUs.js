...
jQuery(document).ready(function($) {
	var aLiLen = $('#cuhkszList li').length;
	var bFlag = true;
	function def(){
		for(var i = 6;i < aLiLen; i++){
			$('#cuhkszList li').eq(i).hide();
		}
	}
	def();
	$('#more i').on('click touchstart',function(){
		if(bFlag == true){
			for(var i = 0;i < aLiLen; i++){
				$('#cuhkszList li').eq(i).show();
			}
			$(this).text('收起')
			bFlag=false;
		}else{
	...
	function tab(){
		var parentWidth = $('.cuhksz-science-field').width();
		var li_Len = $('#list-unstyled').find('li').length;
		var zenLi = $('<li class="lest-li1"><a><img src="../images/dsj_0.jpg"><div class="cuhksz-text"><h3>机器人与智能制造</h3><p><span>—</span></p></div></a></li>');
		var zenLi1 = $('<li class="lest-li1"><a><img src="../images/dsj_0.jpg"><div class="cuhksz-text"><h3>机器人与智能制造</h3><p><span>—</span></p></div></a></li>');
		var zenLi2 = $('<li class="lest-li1"><a><img src="../images/dsj_0.jpg"><div class="cuhksz-text"><h3>机器人与智能制造</h3><p><span>—</span></p></div></a></li>');

		if(parentWidth < 975 && parentWidth > 662){
			$('#list-unstyled').append(zenLi);
			$('#list-unstyled').append(zenLi1);
		}
		if(parentWidth < 663) {
			$('#list-unstyled').append(zenLi);
			$('#list-unstyled').append(zenLi1);
			$('#list-unstyled').append(zenLi2);
		}
	}
	tab();
